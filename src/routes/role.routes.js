...
router.patch('/id/:id', auth(UserRole.Admin, UserRole.SuperUser), updateRoleSchema, awaitHandlerFactory(roleController.updateRole)); // localhost:3000/api/v1/roles/id/1 , using patch for partial update
router.delete('/id/:id', auth(UserRole.Admin, UserRole.SuperUser), awaitHandlerFactory(roleController.deleteRole)); // localhost:3000/api/v1/roles/id/1
